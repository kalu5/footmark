...
// effect(() => {
//   console.log ('baz' in newObj, 'newObj============= in')})

// effect(() => {
//   console.log (newObj.baz, 'newObj=============baz')
// })
// newObj.baz = 3
...
// effect(() => {
//   console.log (newObj.foo.bar, 'newObj=============foo barz =====')
// })
...
const { render } = renderer(platApis)
const vnode = {
  type: 'div',
  props: {
    class: 'test',
...
effect(() => {
  ...
  render(cvnode, document.getElementById('app'))
})
